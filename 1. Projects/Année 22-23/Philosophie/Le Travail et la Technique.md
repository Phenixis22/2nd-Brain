# Le Travail
Le travail a une place très important dans notre culture mais c'est aussi quelque chose que l'on voudrait éviter. Cette ambiguïté est culturelle.
...
# La Technique
Ce qui semble déterminant, c'est l'apparition de l'industrie. Pourtant, quel est l'impact de la Technique dans l'évolution du Travail ?
Il n'existe pas d'étude complète sur la Technique car elle est un moyen mis en oeuvre pour travailler dans l'Antiquité par les esclaves. La réfléxion sur les techniques par rapport au développement des techniques a donc pris du retard. À notre époque, la technique a beaucoup plus d'importance.
## Le progrès technique
Il existe un rapport ambivalent entre la valeur apporté à la technique et la méfiance que l'on développe vis-à-vis d'elle. Ce rapport est remarquable *via* les histoires comme <u>Horizon Zero Dawn</u> où la technologie prend le dessus sur l'Homme

Les techniques modernes sont plus valorisées que les techniques anciennes. La Technique est un critère de distinction culturelle, les occidentaux sont les seuls à valoriser autant la technique. On n'utilise pas seulement la technique, comme dans les cultures traditionnelles par exemple, c'est un principe, une valeur, presque un devoir d'améliorer les techniques. Le progrès de cette technique est un critère de développement.

Le mot progès a deux significations :
 - Une évolution/amélioration des objets techniques
 - Une amélioration de la vie de l'Homme

### Le corps, l'outil, la machine
Les techniques sont des choses que l'on produit, elles sont indénombrables, irreprésentables, etc... Pourtant, quelles sont les étapes de l'évolution de la technique ?
Le corps est la base, pas vis-à-vis de ses besoins mais des techniques employées pour y répondre. Le corps est le premier lieu où les Hommes ont produit des techniques qui sont à l'origine artificielle, comme la marche. 

Selon Aristote, l'Homme a une particularité physique qui le distingue des autres animaux et qui le prédisposerait à la technique : la main. Elle permet tout d'abord de saisir les choses, donc l'utilisation d'outils, et est multi-fonction car elle permet une vaste amplitude de gestes et mouvements. La combinaison des deux possibilités offertes par la main permet la céation, l'amélioration et l'utilisation d'outil de manière élaborée.

L'outil est un prolongement du corps en termes de fonctionnalité car il prolonge le potentil de la main. L'outil permet de faire mieux, voire même plus que ce que l'on peut faire. Il permet un développement uniquement qualitatif. Ce gain est un gain de temps et d'efficacité qui permet l'évolution suivante : les machines.

Dans les cultures traditionnelles, les machines n'existent pas : elles sont rejetées intentionnellement. La culture occidentale, ayant développé des machines, se pensait supérieur. Le gain provoqué par l'évolution jusqu'au machine est encore une fois un gain de temps et d'efficacité. Il permet aussi à l'Homme de ne plus travailler : ce dernier n'est plus nécessaire au fonctionnement de la machine qui utilise une autre source d'énergie. D'ailleurs, l'apparition des autres sources d'énergies a permit l'abolition de l'esclavage. C'est au moment de la prise de conscience que les machines permettent une libération du corps de l'homme qu'est apparu l'idéal de ne plus travailler. Pourtant, nous travaillons encore de nos jours, l'évolution est différente de nos attentes. Alors, pourquoi travaillons-nous encore ? Y a-t-il des raisons techniques ?
### Essence de la technique - Heidegger
Heidegger revient aux Grecs qui s'intéressaient à la vérité. Le sens premier de la vérité est "ce qui n'est plus caché", la vérité est tout ce qui a été dévoilé. Voilà l'essence de la vérité : le dévoilement. La science est née afin de faire apparaître la vérité. Heidegger veut montrer que la technique à la même essence que la vérité : le dévoilement. 

```ad-help
title: Qu'est-ce que la technique dévoile ? 
collapse: open
icon: question
color: 0, 255, 0
```

La technique dévoile de l'énergie. La fascination des hommes pour le dévoilement est la raison de la valeur donnée au progrès. Pourtant, l'essence de la technique a été bouleversé par la création d'un nouveau type de technique. La technique au sens ancien était basée sur un phénomène naturel. Le phénomène naturel donnait lieu à une technique qui créait ensuite de l'énergie. Dorénavant, il existe une étape supplémentaire: un phénomène naturel donne lieu à une technique qui entraîne un phénomène artificiel qui crée une technique qui dévoile de l'énergie. Cette énergie n'est plus naturelle, elle est provoquée

Selon Heidegger, lorsque l'on crée un phénomène artificel, on provoque pas seulement de l'énergie, mais aussi la nature. Cette provocatione se conclue par la provocation de nous-mêmes. L'Homme se provoque donc lui-même. La réalité a été changée, la provocation entraîne des phénomènes nouveaux créés artificiellement par des ingénieurs pour une certaine raison, un aspect du phénomène entier. Les conséquences de ce phénomène sont bien plus grandes que l'aspect sur lequel les ingénieurs se concentrent. La concentration sur un seul phénomène rend invisible les effets secondaires.

Pour Paul Virilio, ses effets secondaires sont "des accidents". Chaque technique créée crée des accidents, cela fait partie de la technique. Ces accidents ne sont ni positifs ni négatifs. Ce sont simplement les contreparties de la technique. Lors de la création de l'avion, on créa aussi le crash. Tout comme les accidents de Virilio ne sont ni positifs ni négatifs, la provocation d'Heidegger ne l'est pas non plus. Elle est incontrôlée. Nous nous provoquons nous mêmes.
### Expérience et technique - Aristote (-384 - -322)
